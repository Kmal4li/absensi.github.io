                  ...
                  <div class="content mt-3">
                      ...
                      <div class="card-header"> 
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                          <td><h5 class="card-title">Data pegawai</span></h5></td>
                                          <td> 
                                            <div align="right">   
                                              <a href="{{ url('pegawai/show')}}"  class="btn btn-success btn-sm"  role="button" aria-disabled="true">
                                  ...
                                  <table class="table table-borderless datatable">
                                              ...
                                              <tbody>
                                                ...
                                                <tr>
                                                        ...
                                                        <td>{{$item -> email}}</td>
                                                        <td>{{$item -> no_hp}}</td>
                                                        <td><a href="{{ url('pegawai/' .$item->id_pegawai.'/edit')}}" class="btn btn-success btn-sm" >
                                                        <span class="bi bi-pencil-square" style="font-size:12px"></span></a></td>
                                                        <td>
                                                        <form action="{{ url('pegawai/' .$item->id_pegawai)}}" method="post" class="d-inline" onsubmit="return confirm('Yakin Hapus Data')">
                                                                @method('delete')
                                                                @csrf
